...
typedef NS_ENUM(NSUInteger, RCTAVideoCacheStatus) {
  RCTAVideoCacheStatusMissingFileExtension,
  RCTAVideoCacheStatusUnsupportedFileExtension,
  RCTAVideoCacheStatusNotAvailable,
  RCTAVideoCacheStatusAvailable
};

@class SPTPersistentCache;
@class SPTPersistentCacheOptions;

@interface RCTAVideoCache : NSObject
{
...
- (void)getItemForUri:(NSString *)url withCallback:(void(^)(RCTAVideoCacheStatus, AVAsset * _Nullable)) handler;
